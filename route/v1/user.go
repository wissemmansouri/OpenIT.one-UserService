...
import (
	...
	"github.com/wissemmansouri/OpenIT.one-UserService/model/system_model"
...
func GetUserImage(c *gin.Context) {
	...
	// @tiger - RESTful According to the standards, it should not return the content of the file itself, but rather the static URL of the file, to be parsed by the frontend.
...
// @Summary Check if in boot state
// @Produce  application/json
// @Accept application/json
// @Tags sys
// @Security ApiKeyAuth
